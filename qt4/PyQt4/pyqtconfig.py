...
_pkg_config = {
    ...
    'pyqt_config_args':  '-q /usr/local/Trolltech/Qt-4.8.7/bin/qmake',
    'pyqt_mod_dir':      '/usr/lib64/python2.7/lib/PyQt4',
    'pyqt_modules':      'QtCore QtGui QtHelp QtMultimedia QtNetwork QtDeclarative QtScript QtScriptTools QtXml QtSql QtSvg QtTest QtXmlPatterns QtDesigner',
    'pyqt_sip_dir':      '/usr/share/sip/PyQt4',
    'pyqt_sip_flags':    '-x VendorID -t WS_X11 -x PyQt_SessionManager -x PyQt_OpenSSL -x PyQt_NoPrintRangeBug -t Qt_4_8_6 -x Py_v3 -g',
    'pyqt_version':      0x040b04,
    'pyqt_version_str':  '4.11.4',
    'qt_archdata_dir':   '/usr/local/Trolltech/Qt-4.8.7',
    'qt_data_dir':       '/usr/local/Trolltech/Qt-4.8.7',
    'qt_dir':            '/usr/local/Trolltech/Qt-4.8.7',
    'qt_edition':        'free',
    'qt_framework':      0,
    'qt_inc_dir':        '/usr/local/Trolltech/Qt-4.8.7/include',
    'qt_lib_dir':        '/usr/local/Trolltech/Qt-4.8.7/lib',
    'qt_threaded':       1,
    'qt_version':        0x040807,
    'qt_winconfig':      'shared'
}
...
_default_macros = {
    ...
    'INCDIR_QT':                '/usr/local/Trolltech/Qt-4.8.7/include',
    ...
    'LIBDIR_QT':                '/usr/local/Trolltech/Qt-4.8.7/lib',
    ...
    'MKDIR':                    'mkdir -p',
    'MOC':                      '/usr/local/Trolltech/Qt-4.8.7/bin/moc',
    'RANLIB':                   '',
    'RPATH':                    '',
    'STRIP':                    'strip'
}
